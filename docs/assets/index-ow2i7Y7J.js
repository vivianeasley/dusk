(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const l of s)if(l.type==="childList")for(const i of l.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function a(s){const l={};return s.integrity&&(l.integrity=s.integrity),s.referrerPolicy&&(l.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?l.credentials="include":s.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function n(s){if(s.ep)return;s.ep=!0;const l=a(s);fetch(s.href,l)}})();const be=(e,t)=>{let a=structuredClone(e),n=!1;const s=()=>structuredClone(a),l=i=>{t(i),a=i};return n===!1&&(t(e),n=!0),{get:s,set:l}},f=(e,...t)=>e.reduce((a,n,s)=>a+n+(t[s]??""),""),k=(e,t)=>e.map(t).join(""),te=(e,t)=>{e.innerHTML=t()};function xe(){const e=new Map;return{startFlip(){e.clear(),document.querySelectorAll("[data-flip]").forEach(t=>{const a=t.getAttribute("data-flip");e.set(a,t.getBoundingClientRect())})},endFlip(t=200){return new Promise(a=>{const n=[];document.querySelectorAll("[data-flip]").forEach(s=>{const l=s.getAttribute("data-flip"),i=e.get(l);if(!i)return;const r=s.getBoundingClientRect(),c=i.left-r.left,y=i.top-r.top;(c!==0||y!==0)&&(s.style.transform=`translate(${c}px, ${y}px)`,n.push(s))}),requestAnimationFrame(()=>{n.forEach(s=>{s.style.transition=`transform ${t}ms ease`,s.style.transform=""}),setTimeout(()=>{n.forEach(s=>{s.style.transition=""}),e.clear(),a()},t)})})}}}const ke=e=>{for(let t=e.length-1;t>0;t--){const a=Math.floor(Math.random()*(t+1));[e[t],e[a]]=[e[a],e[t]]}return e},R=e=>{if(!e)return"";let t=e.replace(/([a-z])([A-Z0-9])/g,"$1 $2");return t=t.toLowerCase(),t=t.charAt(0).toUpperCase()+t.slice(1),/[.!?]$/.test(t)||(t+="."),t},E=e=>e[Math.floor(Math.random()*e.length)],K=()=>Math.random(),ae=e=>Math.floor(Math.random()*e)+1,se=(e,t,a={})=>{var y,$;const n=e.getAttribute("d");if(!n)throw new Error(`Element "${id}" has no 'd' attribute`);const s=/-?\d*\.?\d+(?:e[-+]?\d+)?/gi,l=(y=n.match(s))==null?void 0:y.map(Number),i=($=t.match(s))==null?void 0:$.map(Number);if(!l||!i||l.length!==i.length)throw new Error("Start and target paths must have identical command structure and number count.");const r=a.easing||(b=>.5-.5*Math.cos(Math.PI*b)),c=Math.max(1,a.duration||800);return new Promise(b=>{const C=(v,m,x)=>v+(m-v)*x;let g;function I(v){g??(g=v);const m=Math.min(1,(v-g)/c),x=r(m),d=l.map((u,w)=>C(u,i[w],x)),p=n.replace(s,()=>{const u=d.shift();return Math.abs(u)<1e-6?"0":u.toFixed(3).replace(/\.?0+$/,"")});e.setAttribute("d",p),m<1?requestAnimationFrame(I):b()}requestAnimationFrame(I)})},ne=e=>{const t=document.querySelectorAll(".upper-brow"),a=e?600:600+ae(200),n=`m-6,0l649,0l0,${a}c-119.17,-95.85 -41.92,-306.25 -163.12,-392.89c-104.61,-77.09 -381.27,-13.02 -485.88,-90.11z`;for(let s=0;s<t.length;s++)se(t[s],n,{duration:200+a*3})},Q=e=>{const t=document.querySelectorAll(".iris"),a=e?"m345.22,45c-188.76,49.98 -199.63,117.3 -216.1,197.88c2.69,140.76 156.4,202.98 220.35,210.12c2.13,0 200.44,-22.44 196.5,-210.12c-5.14,-149.94 -200.76,-197.88 -200.76,-197.88z":"m330.55,45c-23.96,49.98 -25.34,117.3 -27.43,197.88c0.34,140.76 19.85,202.98 27.97,210.12c0.27,0 25.44,-22.44 24.94,-210.12c-0.65,-149.94 -25.48,-197.88 -25.48,-197.88z";for(let n=0;n<t.length;n++)setTimeout(()=>{se(t[n],a,{duration:500})},2200)},M=(e,{size:t=256,cell:a=14,jitter:n=.85}={})=>{const s=t,l=d=>Math.max(0,Math.min(s-1,d)),i=document.createElement("canvas");i.width=i.height=s;const r=i.getContext("2d",{willReadFrequently:!0});function c(d,p){r.clearRect(0,0,s,s),r.textAlign="center",r.textBaseline="middle",r.font=`${s*.78}px ${p}`,r.fillStyle="#000",r.fillText(d,s/2,s/2)}function y(){const d=r.getImageData(0,0,s,s).data;for(let p=3;p<d.length;p+=4)if(d[p]!==0)return!0;return!1}const $=['"Apple Color Emoji","Segoe UI Emoji","Noto Color Emoji",sans-serif','"Segoe UI Emoji","Noto Color Emoji","Apple Color Emoji",sans-serif',"sans-serif"];let b=!1,C=e;for(let d=0;d<3&&!b;d++)c(C,$[d]),b=y(),!b&&d===0&&!/\uFE0F/.test(C)&&(C=e+"️",d--);b||(r.clearRect(0,0,s,s),r.fillStyle="#000",r.fillRect(s*.25,s*.25,s*.5,s*.5));const g=[],I=a*n*.5;for(let d=0;d<=s;d+=a){const p=[];for(let u=0;u<=s;u+=a){const w=u>0&&u<s?(Math.random()*2-1)*I:0,T=d>0&&d<s?(Math.random()*2-1)*I:0;p.push([l(u+w),l(d+T)])}g.push(p)}const v=document.createElement("canvas");v.width=v.height=s;const m=v.getContext("2d");function x(d,p,u){const w=l((d[0]+p[0]+u[0])/3|0),T=l((d[1]+p[1]+u[1])/3|0),P=r.getImageData(w,T,1,1).data;P[3]<1||(m.beginPath(),m.moveTo(d[0],d[1]),m.lineTo(p[0],p[1]),m.lineTo(u[0],u[1]),m.closePath(),m.fillStyle=`rgba(${P[0]},${P[1]},${P[2]},${(P[3]/255).toFixed(3)})`,m.fill())}for(let d=0;d<g.length-1;d++)for(let p=0;p<g[d].length-1;p++){const u=g[d][p],w=g[d][p+1],T=g[d+1][p],P=g[d+1][p+1];Math.random()<.5?(x(u,w,P),x(u,P,T)):(x(u,w,T),x(w,P,T))}return v.toDataURL("image/png")},le=(e,t)=>{if(console.log(t),typeof t!="number"||t<=0){const a=e.get(),n=a.activePlayer==="player"?"player":"opponent";let s=0;for(let l=0;l<a[n].play.length;l++)a[n].play[l].types.includes(t)&&a[n].play[l].isExhausted===!1&&s++;return s}return t},Ae=e=>e.deck[e.deck.length-1],ie=(e,t,a,{toStart:n=!1}={})=>{const s=e.findIndex(i=>i.id===a);if(s===-1)return null;const[l]=e.splice(s,1);return n?t.unshift(l):t.push(l),l},re=async(e,t)=>{for(let a=0;a<e&&await t(a)!==!1;a++);};async function N(e,t,a){const n=le(e,a);await re(n,async()=>{const s=e.get(),l=Ae(s);if(!l)return!1;l.isFaceUp=!0,ie(s.deck,s[t].play,l.id),e.set(s),await h(1e3)})}async function X(e,t,a){const n=le(e,a);await re(n,async()=>{const s=e.get(),l=s[t].play;if(!l.length)return!1;const i=l[l.length-1];if(!i)return!1;i.isFaceUp=!1,ie(l,s.deck,i.id,{toStart:!0}),e.set(s),await h(1e3)})}const V={floodOpponent$Time:async(e,t,a)=>{await N(e,t==="player"?"opponent":"player",a)},floodAllPlayers$Time:async(e,t,a)=>{await N(e,"player",a),await N(e,"opponent",a)},return$Time:async(e,t,a)=>{await X(e,t,a)},forEach$InYourPlayAreaFloodYourOpponent:async(e,t,a)=>{await N(e,t==="player"?"opponent":"player",a)},forEach$InYourPlayAreaReturnACard:async(e,t,a)=>{await X(e,t,a)},remianingCardsInPileGoToYourPlayArea:async(e,t,a)=>{await h(1e3);const n=e.get();n.isPileToPlay=!0,e.set(n)},turn2$OfYourOpponentsCardsFaceDown:async(e,t,a)=>{await h(1e3);const n=e.get(),s=n.activePlayer;let l=s==="player"?n.opponent.play:n.player.play,i=0;for(let r=0;r<l.length;r++){const c=l[r];if(console.log(c.types,a),!c.isExhausted&&c.types.includes(a)&&(c.isExhausted=!0,i++),i>=2)break}i>=15&&(n.winner=s==="player"?"You":"The Void"),e.set(n)},ifYouHave10OrMore$CardsYouWinTheGame:async(e,t,a)=>{await h(1e3);const n=e.get(),s=n.activePlayer;let l=s==="player"?n.player.play:n.opponent.play,i=0;l.forEach(r=>{!r.isExhausted&&r.types.includes(a)&&i++}),i>=10&&(n.winner=s==="player"?"You":"The Void"),e.set(n)}},oe=["💖","💘","💝","🔥","💃","💄","🌋","🌶️","🍅","🥩","🧨","🎈","🎉","📕","☎️","🚗","🚒","🛑","🦑","🧯","🦀","🦞","🦐","🧣","🦊","🦁","🪔","🛢️","🧱"],ce=["🧊","🌊","🌀","❄️","☃️","🌌","🪐","⭐","🌠","🧞","🦋","🐬","🐟","🐳","🐢","🐍","🐸","🦖","🌴","🌳","🍀","🌿","🍏","🥝","🥒","🥦","🫐","🧵","👖","📘","💎","🔵","🔷","🟩","🟦","🕺"],de=["🤍","🖤","🤎","🪨","🏺","🪵","🪑","⚱️","⚙️","📦","📜","📄","📓","📰","💼","🥋","🥔","🍞","🥖","🪙","💰","🛋️","🪞","🧳","🏚️","⚫","⚪","📎","🧂","🗿","🛡️"],U=["Umbral","Void","Eclipse","Oblivion","Specter","Nebula","Wraith","Abyss","Crypt","Ethereal","Stellar","Hollow","Phantom","Cosmic","Chasm","Lunar","Grave","Singularity","Haunt","Infernal","Asteroid","Orbit","Shadow"],F=["rift","echo","omen"],J={rift:Me,echo:Te,omen:Se},A=Object.keys(V),Y={};let pe=3,ue=3,fe=3;const q=["c","c","c","c","c","c","c","c","c","u","u","u","u","r","r"],Ee=e=>{const t=[];for(let a=0;a<5;a++){const n=F[a]?F[a]:F[a-2];t.push(D([n],t.length+1,void 0,a))}return q.forEach(a=>{const n=L(["rift"],a);pe++,t.push(D(["rift"],t.length+1,n,3))}),q.forEach(a=>{const n=L(["echo"],a);ue++,t.push(D(["echo"],t.length+1,n,3))}),q.forEach(a=>{const n=L(["omen"],a);fe++,t.push(D(["omen"],t.length+1,n,3))}),ke(t)};function D(e,t,a,n){return{id:t,name:a!=null&&a.name?a.name:he(),types:e,isFaceUp:!1,isSelected:!1,isActive:!1,abilityFunct:a?a.abilityFunct:[],abilityRule:a?a.abilityRule:[],isExhausted:!1,cardArt:a!=null&&a.art?a.art:s()};function s(){let l;return e.length>1||(e[0]==="rift"?l=M(oe[n],{size:100,cell:12}):e[0]==="echo"?l=M(ce[n],{size:100,cell:12}):l=M(de[n],{size:100,cell:12})),l}}function Me(e,t,a){let n=a||1,s=e==="c"?0:1;e==="r"&&(n=E(F),s=3);const l=A[s];return{funct:l+":"+n,rule:R(l.replace("$"," "+n+" "))}}function Te(e){let t=1,a=2;e==="r"&&(t=E(F),a=4);const n=A[a];return{funct:n+":"+t,rule:R(n.replace("$"," "+t+" "))}}function Se(e,t){if(e==="c")return{funct:A[5],rule:R(A[5])};if(e==="u"){const a=E(F);return{funct:A[6]+":"+t,rule:R(A[6].replace("$"," "+a+" "))}}else{const a=E(F);return{funct:A[7]+":"+t,rule:R(A[7].replace("$"," "+a+" "))}}}function L(e,t){let a=[],n=[];for(let i=0;i<e.length;i++){const r=e[i],c=J[r](t,e[i]);if(a.push(c.funct),n.push(c.rule),r==="omen"&&t==="r"){const y=J.rift("c","omen",2);a.push(y.funct),n.push(y.rule)}}const s=a.join("")+e.join("");let l={};if(Y[s])l.name=Y[s].name,l.art=Y[s].art;else{let i;e.length>1||(e[0]==="rift"?i=M(oe[pe],{size:100,cell:12}):e[0]==="echo"?i=M(ce[ue],{size:100,cell:12}):i=M(de[fe],{size:100,cell:12})),l.name=he().slice(0,21),l.art=i,Y[s]=l}return{name:l.name,art:l.art,abilityFunct:a,abilityRule:n}}function he(){const e=K(),t=K(),a=E(U),n=E(U),s=e>.5?a:`${a.slice(0,a.length-3)}'${E(U)}`,l=t>.5?n:`${E(U)}-${n}`;return`${s} ${l}`}const ye=Ee();console.log(ye);const me=["deal","take","end"],Fe={isStarted:!1,isPhaseButtonDisabled:!0,isPileToPlay:!1,winner:void 0,activePlayer:"player",currentPhase:void 0,phases:me,isModalOpen:!1,ui:{},deck:ye,selectedPile:"pile1",pile1:[],pile2:[],pile3:[],player:{id:1,hand:[],play:[],isComputer:!1},opponent:{id:2,hand:[],play:[],isComputer:!0}},Oe=M("🌌",{size:500,cell:15});function S(e,t,a,n,s){var i,r;let l=e.types[0];return e.types.length>1&&(l="multi"),f`
    <div class="card-wrapper ${e.isActive?"active-card":""} ${e.isExhausted?"played":""}" ${t?"":"data-flip="+e.id}>
      <div class="card-container ${e.isFaceUp||a?"face-up":"face-down"}">
        <div class="card ${n?"pulse-border":""}">
          <div class="card-face front ${l}">
            <div class="card-name">${e.name}</div>
            <img class="card-image" src="${e.cardArt}">
            ${e.isExhausted?"":f`<div class="card-type">${(i=e.types)==null?void 0:i.join(" - ")}</div>`}
...
`)}</div>
            ...
            <div class="game-rules-wrapper">
                <div class="flex-col">
                    ...
                    <ul>
                        ...
                        <li>Return: Return a card from you play area to the bottom of the deck. Face down cards are returned first followed by the last card you played.</li>
                    </ul>
                    </div>
  ...
  `}function je(e){let t=0,a=0,n=0;for(let s=0;s<e.player.play.length;s++)e.player.play[s].types.includes("rift")&&t++,e.player.play[s].types.includes("echo")&&a++,e.player.play[s].types.includes("omen")&&n++;return f`
        <div class="dialog">
            <div>Select this pile of cards by clicking the take button. Cards resolve in numerical order.</div>
            <div>Your play area has ${t} rifts, ${a} echos, and ${n} omens</div>
            <div class="flex-column">
                <div class="flex-cards">
                ${k(e[e.selectedPile],(s,l)=>{var i;return f`
                        <div>
                            <div class="deck-card-wrapper">${S(s,!0,!0)}</div>
                        ${((i=e[e.selectedPile])==null?void 0:i.length)>1?f`<div class="number-buttons-wrapper"><button class="jagged" onclick="methods.orderCards(['${e.selectedPile}'], ${s.id}, false)">⬅</button><div class="number">${l+1}</div><button class="jagged" onclick="methods.orderCards(['${e.selectedPile}'], ${s.id}, true)">⮕</button></div>`:""}
                        </div>`})}
                </div>
  ...
  `}function Ne(e){var s,l,i;const t=me[e.currentPhase],n=(e.currentPhase?["play","end"]:["take","end"]).includes(t)?e.activePlayer==="player"?"opponent":"player":e.activePlayer;return f`
    <div>
        ...
        <div class="game-area-wrapper">
            <div class="deck-dealt-wrapper">
                ...
                <div class="pile-wrapper pile-2-wrapper">${((l=e.pile2)==null?void 0:l.length)>0?k(e.pile2,(r,c)=>f`<div onclick="methods.viewPile('pile2')" class="pile" style="${"bottom:"+c*2+"px;right:"+c*2+"px"}">${S(r,!1,!1,e.currentPhase===1&&e.activePlayer==="player")}</div>`):""}</div>
                <div class="pile-wrapper pile-3-wrapper">${((i=e.pile3)==null?void 0:i.length)>0?k(e.pile3,(r,c)=>f`<div onclick="methods.viewPile('pile3')" class="pile" style="${"bottom:"+c*2+"px;right:"+c*2+"px"}">${S(r,!1,!1,e.currentPhase===1&&e.activePlayer==="player")}</div>`):""}</div>
            </div>
